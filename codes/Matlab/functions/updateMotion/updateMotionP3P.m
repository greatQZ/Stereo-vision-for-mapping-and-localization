...
% points3D_1 = triangulate(im_pts1_l, im_pts1_r, stereoParams060319)';
points3D_1 = triangulate(im_pts1_l, im_pts1_r, P1', P2')';
% invert x-y corrdinates for image processing tooblox

% motion estimation by minimizing reprojection error and RANSAC
cam1 = cameraIntrinsics([P1(1, 1), P1(2,2)], [P1(1, 3), P1(2, 3)], dims);
% cam1 = stereoParams020519.CameraParameters1;
% cam1 = stereoParams060319.CameraParameters1;
warningstate = warning('off','vision:ransac:maxTrialsReached');
[R, tr] = estimateWorldCameraPose(im_pts2_l, points3D_1', cam1, 'MaxNumTrials', 5000, 'Confidence', 99, 'MaxReprojectionError', 0.6);
