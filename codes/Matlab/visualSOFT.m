function [R, tr, vo_previous_updated, bucketed_matches] = visualSOFT(t, I1_l, I2_l, I1_r, I2_r, P1, P2, vo_params, vo_previous)
...
% indexPairs = matchFeatures(pts1_l, pts1_r, 'Unique', true, 'Metric', 'SAD');
...
% [R, tr] = updateMotionP3P(bucketed_matches, dims,stereoParams060319);
